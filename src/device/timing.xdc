...
#set_input_delay -clock p0_rx_clk -clock_fall -max 2.000  [get_ports -filter {NAME =~ p0_rxdat[*]}]
#set_input_delay -clock p0_rx_clk -clock_fall -min 0.000  [get_ports -filter {NAME =~ p0_rxdat[*]}]
#
#set_input_delay -clock p0_rx_clk -clock_fall -max 2.000 [get_ports {p0_rxdv p0_rxer p0_crs p0_col}]
#set_input_delay -clock p0_rx_clk -clock_fall -min 0.000 [get_ports {p0_rxdv p0_rxer p0_crs p0_col}]
...
#set_property IOB TRUE [get_ports -filter {NAME =~ p0_rx_dat[*]}]
#set_property IOB TRUE [get_ports {p0_rxdv p0_rxer p0_crs p0_col}]
#set_property IOB TRUE [get_ports -filter {NAME =~ p0_tx_dat[*]}]
#set_property IOB TRUE [get_ports {p0_txen p0_txer}]
