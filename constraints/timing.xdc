...
set_input_delay -max 0.500 -clock p0_rxsclk_src [get_ports -filter {NAME =~ p0_rxdat[*]}]
set_input_delay -max 0.500 -clock p0_rxsclk_src [get_ports -filter {NAME =~ p0_rxdat[*]}] -clock_fall -add_delay
set_input_delay -min 3.500 -clock p0_rxsclk_src [get_ports -filter {NAME =~ p0_rxdat[*]}]
set_input_delay -min 3.500 -clock p0_rxsclk_src [get_ports -filter {NAME =~ p0_rxdat[*]}] -clock_fall -add_delay
set_input_delay -max 0.500 -clock p0_rxsclk_src [get_ports {p0_rxdv}]
set_input_delay -max 0.500 -clock p0_rxsclk_src [get_ports {p0_rxdv}] -clock_fall -add_delay
set_input_delay -min 3.500 -clock p0_rxsclk_src [get_ports {p0_rxdv}]
set_input_delay -min 3.500 -clock p0_rxsclk_src [get_ports {p0_rxdv}] -clock_fall -add_delay
set_input_delay -max 0.500 -clock p0_rxsclk_src [get_ports {p0_crs}]
set_input_delay -max 0.500 -clock p0_rxsclk_src [get_ports {p0_col}]
set_input_delay -min 3.500 -clock p0_rxsclk_src [get_ports {p0_crs}]
set_input_delay -min 3.500 -clock p0_rxsclk_src [get_ports {p0_col}]
#set_input_delay 0.000 -clock p0_rxsclk_src [get_ports {p0_int}]
#set_input_delay 0.000 -clock nic_clock [get_ports {p0_mdio}]

set_input_delay -max 0.500 -clock p1_rxsclk_src [get_ports -filter {NAME =~ p1_rxdat[*]}]
set_input_delay -max 0.500 -clock p1_rxsclk_src [get_ports -filter {NAME =~ p1_rxdat[*]}] -clock_fall -add_delay
set_input_delay -min 3.500 -clock p1_rxsclk_src [get_ports -filter {NAME =~ p1_rxdat[*]}]
set_input_delay -min 3.500 -clock p1_rxsclk_src [get_ports -filter {NAME =~ p1_rxdat[*]}] -clock_fall -add_delay
set_input_delay -max 0.500 -clock p1_rxsclk_src [get_ports {p1_rxdv}]
set_input_delay -max 0.500 -clock p1_rxsclk_src [get_ports {p1_rxdv}] -clock_fall -add_delay
set_input_delay -min 3.500 -clock p1_rxsclk_src [get_ports {p1_rxdv}]
set_input_delay -min 3.500 -clock p1_rxsclk_src [get_ports {p1_rxdv}] -clock_fall -add_delay
set_input_delay -max 0.500 -clock p1_rxsclk_src [get_ports {p1_crs}]
set_input_delay -max 0.500 -clock p1_rxsclk_src [get_ports {p1_col}]
set_input_delay -min 3.500 -clock p1_rxsclk_src [get_ports {p1_crs}]
set_input_delay -min 3.500 -clock p1_rxsclk_src [get_ports {p1_col}]
...
set_input_delay -clock pci_clock -max 23.000 [get_ports -filter {NAME =~ GNT_N[*]}]
set_input_delay -clock pci_clock -max 23.000 [get_ports {PAR FRAME_N TRDY_N IRDY_N STOP_N DEVSEL_N PERR_N SERR_N RST_N}]
...
set_input_delay -clock pci_clock -min 0.000 [get_ports -filter {NAME =~ GNT_N[*]}]
set_input_delay -clock pci_clock -min 0.000 [get_ports {PAR FRAME_N TRDY_N IRDY_N STOP_N DEVSEL_N PERR_N SERR_N RST_N}]
...
set_output_delay -clock pci_clock -max 7.000 [get_ports -filter {NAME =~ REQ_N[*]}]
set_output_delay -clock pci_clock -max 7.000 [get_ports {PAR FRAME_N TRDY_N IRDY_N STOP_N DEVSEL_N PERR_N SERR_N INTA_N INTB_N INTC_N INTD_N}]
...
set_output_delay -clock pci_clock -min 0.000 [get_ports -filter {NAME =~ REQ_N[*]}]
set_output_delay -clock pci_clock -min 0.000 [get_ports {PAR FRAME_N TRDY_N IRDY_N STOP_N DEVSEL_N PERR_N SERR_N INTA_N INTB_N INTC_N INTD_N}]
